...
const ToolCard = ({ tool }) => {
    ...
    return (
        <div
            ...
            className="bg-osint-card rounded-lg overflow-hidden border border-gray-800 hover:border-osint-accent transition-all duration-300 shadow-lg hover:shadow-osint-accent/10 flex flex-col h-full cursor-pointer"
        >
